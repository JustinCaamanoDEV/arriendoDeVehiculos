...
<div id="mantenedor">
<div id="cabecera">
            <h2 align="left" style="color: white;">Arriendo de Vehículos</h2>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
            <a href="login.php"><h2 align="right" style="color: white;">Iniciar Sesión</h2></a>
        </div>
        <div id="contenido">
            <!--<td>Hora: </td>-->
    ...
    <table border="0" align="center" bgcolor="#0033BB" style="color: white;">
        <tr>
            <td colspan="4" align="center"><h1>Registro de Usuario</h1></td>
        </tr>
        <tr>
            <td><b>Rut: </b></td>
            ...
            if($_POST['txtDigito']==$dig){
                ...
                ?><script>alert("Ya existe un cliente registrado con ese Rut")</script><?php
                    ...
                    if(empty($nom) || empty($ape) || empty($fec) || empty($sex) || empty($dir) || empty($reg) || empty($fon) || empty($cor) || empty($usu) || empty($con)){
                        ...
                        $sql = "INSERT INTO empleado VALUES ('$rut','$nom','$ape','$fec','$idSex','$dir','$idReg','$fon','$cor','$usu','$con')";
