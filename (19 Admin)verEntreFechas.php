...
<body onload="startTime()">
    ...
    <center>
    <h1 style="color: white;"><b>Consultar Arriendos Entre Fechas</b></h1>
    <table border="0" style="color: white;">
        <tr>
            <td><b>Fecha Inicio: </b></td>
            <td><input type="date" name="txtFecIni" value=""></td>
        </tr>
        <tr>
            <td><b>Fecha Final: </b></td>
            <td><input type="date" name="txtFecFin" value=""></td>
        </tr>
        <tr>
            <td colspan="4" align="center"><input type="submit" name="btnBuscar" style="width:180px; height:50px;" value="VER A TODOS"></td>
        </tr>    
    </table> 
    </form> 
    <?php 
        if($_POST['btnBuscar']=="VER A TODOS"){
            include("funciones.php");
            $cnn = Conectar();
            $fecini = $_POST['txtFecIni'];
            $fecfin = $_POST['txtFecFin'];
            $rs = mysqli_query($cnn, "select * from arriendo where (fechaInicioArriendo between '$fecini' and '$fecfin') or (fechaFinArriendo between '$fecini' and '$fecfin')");
