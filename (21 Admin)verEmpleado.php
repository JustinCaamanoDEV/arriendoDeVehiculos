...
<body onload="startTime()">
    ...
    <center>
    <h1 style="color: white;"><b>Consultar Arriendo por Rut del Empleado</b></h1>
    <table border="0" style="color: white;">
        <tr>
            <td><b>Rut Empleado: </b></td>
            <td><select name="txtRut" style="width:160px">
            <?php
	            echo "<option value='$rut'>Seleccione</option>";
    ...
    <?php 
        if($_POST['btnBuscar']=="VER TODO"){
            $rut = $_POST['txtRut'];
            $rs = mysqli_query($cnn, "SELECT * FROM arriendo WHERE rutEmpleado = '$rut'");
