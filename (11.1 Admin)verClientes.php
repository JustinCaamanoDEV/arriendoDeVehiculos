...
<body onload="startTime()">
    ...
    <center>
    <h1 style="color: white;"><b>Mostrar Todos Los Clientes</b></h1>
    <td><input type="submit" name="btnBuscar" style="width:180px; height:50px;" value="VER TODOS LOS CLIENTES"></td>
    </form> 
    <?php 
        if($_POST['btnBuscar']=="VER TODOS LOS CLIENTES"){
            include("funciones.php");
            $cnn = Conectar();
            $rs = mysqli_query($cnn, "select * from cliente");
