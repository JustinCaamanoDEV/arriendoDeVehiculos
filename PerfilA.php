...
<body onload="startTime()">
    ...
    <br>
    <center>
    <h1><b>Perfil de Administrador</b></h1>
    ...
    <?php 
        if($_POST['btnCargar']=="CARGAR"){
            ...
            $usu = $_POST['txtUsu'];
            $con = $_POST['txtCon'];
            $rs = mysqli_query($cnn, "SELECT * FROM empleado WHERE usuario='$usu'");
    ...
    <table border="0" style="color: white;">
        ...
        <tr>
            <td><b></b></td>
            <td><input type="submit" name="btnCargar" style="width:160px; height:50px;" value="CARGAR"></td>
        </tr>
        <tr>
            <td><b>Rut: </b></td>
            <td><input type="text" name="txtRut" value="<?php echo $datoApe;?>"></td>
        </tr>
        <tr>
            <td><b>Nombres: </b></td>
        ...
        <tr>
            <td><b>Usuario: </b></td>
            <td><input type="text" name="txtUsu2" value="<?php echo $datoUsu;?>"></td>
        </tr>
        <tr>
            <td><b>Contraseña: </b></td>
            <td><input type="text" name="txtCon2" value="<?php echo $datoCon;?>"></td>
        </tr>
        <tr>
            <td><b></b></td>
    ...
    <?php 
        if($_POST['btnModificar']=="MODIFICAR"){
            ...
            $sql = "
            UPDATE empleado
            SET nombres='$nom', apellidos='$ape', fechaNac='$fec', sexo='$idSex', direccion='$dir', region='$idReg', fono='$fon', correo='$cor', usuario='$usu', contraseña='$con'
            where rut='$rut'
            ";
